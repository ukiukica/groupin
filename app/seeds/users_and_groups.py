...
def seed_users_and_groups():
    ...
    caitlin = User(
        username='Caitlin', email='caitlin@aa.io', password='password')
    uki = User(
    ...
    demo.pinned.append(group1)
    demo.pinned.append(group2)
    caitlin.pinned.append(group1)
    caitlin.pinned.append(group3)
    uki.pinned.append(group2)
    uki.pinned.append(group3)
